...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/src/encoding/gob": &vfsgen۰DirInfo{
			name:    "gob",
			modTime: time.Date(2019, 4, 6, 11, 3, 15, 126398833, time.UTC),
		},
		"/src/encoding/gob/gob_test.go": &vfsgen۰CompressedFileInfo{
			name:             "gob_test.go",
			modTime:          time.Date(2019, 4, 6, 11, 3, 15, 126473498, time.UTC),
